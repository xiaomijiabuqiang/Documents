...
insert  into `news`(`id`,`imgpath`,`newsDesc`,`newsinfo`,`createTime`) values 
(1,'1.jpg','新西兰高质量乳铁蛋白 NEWMUK纽盾给出了答案','<p>很多妈妈都知道，母乳是最适合宝宝的口粮，其中一个重要原因就在于，母乳中含有多种能提高孩子免疫力的营养成分——乳铁蛋白。如果不能进行母乳喂养，该如何为宝宝补充乳铁蛋白呢？其实，只要认准了富含乳铁蛋白的伊利金领冠睿护，就能为宝宝带来母乳般呵护。</p><p>乳铁蛋白</p><p>乳铁蛋白是母乳中含量丰富的天然免疫蛋白，可以有效地拦截并杀死入侵宝宝身体的细菌，防止病毒感染人体细胞，帮助宝宝对抗炎症，是帮助宝宝建立免疫功能的关键成分。能提高免疫力的奶粉往往也会添加这种珍稀的成分，比如伊利金领冠睿护婴幼儿配方奶粉就采用冷喷工艺，全面地保留了乳铁蛋白的活性，可以帮助宝宝筑起一道健康防线。</p><p>α－乳清蛋白和β－酪蛋白</p><p>母乳中含有一对重要的蛋白质组合——α－乳清蛋白和β－酪蛋白组合＊，它们不仅有利于吸收和利用，而且能够促进宝宝的生长发育、行为发育以及免疫系统发育。在宝宝对蛋白质需求格外旺盛的生长发育期，这对黄金蛋白组合不可或缺。伊利金领冠睿护基于伊利17年来的母乳研究，在配方中添加了α＋β黄金蛋白组合，能够给宝宝提供有效的保护和全面的营养，尤其适合免疫力较弱的宝宝。</p><p>益生元</p><p>宝宝的肠道粘膜十分脆弱，如果肠道内有害菌过多而益生菌过少，那么很容易因为肠道菌群失调而出现消化功能紊乱、吸收不良、拉肚子和便秘等症状。因此肠道功能健康也是提升宝宝免疫力的重要一环。益生元可以直接进入宝宝的肠道，促进双歧杆菌等益生菌的生长和繁殖，保护宝宝的小肚子，因此妈妈在选择奶粉时也要留意益生元的种类和含量。以伊利金领冠睿护为例，这款奶粉中含有低聚半乳糖（GOS）、低聚果糖（FOS）和异构化乳糖（LOS）三种益生元，可以促进益生菌的生长，消灭有害菌，大大提升宝宝的肠道舒适度，进而增强免疫力。</p>','2020-06-29 09:55:39'),
(2,'2.jpg','谁是了不起的营养食品免疫品牌？且看雅莱牛初乳','<p>相比渗透率非常高的婴幼儿配方奶粉、纸尿裤，母婴营养食品渗透率非常低，加上消费年龄段更长，因此母婴营养食品市场未来的增量空间非常大。</p><p>但相比门槛较高的保健食品，母婴营养食品的进入门槛要低很多，加上母婴渠道为营养食品的销量创造了通路，一大批投机型的品牌进入了市场，市场上品牌超过2000个，而且新品牌不断增加中，产能过剩、产品同质化现场逐步凸显。而能够在异常拥挤的品牌赛道上脱颖而出，则绝对被称之为“了不起”的品牌。0-6岁是小众市场，营养食品真正的大市场在家庭消费。一部分优势品牌在母婴品类的基础上，已经开始往家庭消费布局。如雅莱牛初乳确定了“专注高端免疫 成就健康家庭”的目标，与竞争对手形成区隔，建立起属于自己的市场范围。</p><p>2020年4月，中国婴童网&育儿网&N20成员联合发布《2020母婴营养食品产业发展蓝皮书》中就植入了雅莱牛初乳，这是行业对于雅莱牛初乳对于营养食品免疫行业做出贡献的肯定，也是对于雅莱牛初乳链接全家健康新主张的认可。从母婴带链接家庭，雅莱牛初乳正一步步踏实前行，用奋斗和创新铸就中国健康产业梦。当别人还在用原有的打法布局营养食品免疫市场时，专业的雅莱牛初乳已先行一步，开启全家健康新玩法！未来，雅莱牛初乳还将继续深扎营养食品免疫领域，为更多的家庭输送专业高端的营养免疫产品。</p>','2020-06-29 09:55:41'),
(3,'3.jpg','比蚊香安全，比蚊帐方便，你想要的全套靠谱驱蚊方式长这样','<p>随着天气逐渐温暖，有的地方都能穿短袖了，夏天的脚步近了，沉寂了一冬天的蚊子又开始蠢蠢欲动了！</p><p>通常我们会把被蚊虫叮咬看做一件“ 小事”，但其实，蚊子就像是病毒轰炸机，一只蚊子能携带80多种病毒，像乙型脑炎、登革热病、疟疾等等。根据科学调查与研究表明全球7亿人感染各种疾病，导致100万人死亡，真凶就是“蚊子”，因此蚊子也被称为杀人最多的动物。年年岁岁蚊相似，岁岁年年疫相同，被蚊子叮咬过后除了难忘的瘙痒与“红包”更应该关心——是否传染上疾病。因为它可能是刚去过隔壁家厕所的蚊子接着爬上你的餐桌，登上你的面包，溜进你的水杯。最后携带各种传染病病菌，通过叮咬你的皮肤，把毒液注射进你的身体。</p><p>而“受害人”之中最痛苦的要数宝宝了，嫩嫩的肌肤成了蚊子们，观光享受美餐的打卡圣地。所以，24h随时驱蚊才是健康之重。这不仅是防蚊虫叮咬，更是防细菌病毒传播。为了能驱蚊又能很好地保护我们的健康，安贝儿新推出喜羊羊与灰太狼天然精油驱蚊系列，天然草本植物精油强悍驱蚊，不添加避蚊胺安全无毒，是家里孕妇小孩都能用的驱蚊好物！</p>','2020-06-29 09:55:44'),
(4,'4.jpg','95后妈妈来了！她们的画像和消费观有何不同?','<p>“比市场更了解宝宝需求的是妈妈，比妈妈更了解市场需求的是数据“。</p><p>随着90后、95后妈妈躯体向母婴消费市场大肆涌入，新生代家庭对与下一代养护的重视程度越来提高，持续增长的母婴市场规模和不断细化的母婴市场需求，为母婴企业的发展带来了前所未有的历史机遇。</p><p>如今的母婴产业范围涵盖了衣、食、住、用、行、育、乐等各个方面，为了分食母婴这块“超级蛋糕”，包括母婴用品厂家、实体零售企业、广告营销机构等行业上下游角色，纷纷开始进入母婴板块，加紧了在母婴市场的布局。而想要更好的了解母婴市场动向，实现精准营销与布局，充分了解新生代妈妈的消费偏好与基本用户数据，则是其中非常关键的一环。猝不及防地，最大的95后妈妈已经24岁了，就连85后妈妈都已经25-34了...</p><p>自2017年之后，95后妈妈开始粉墨登场。虽然当前的妈妈群体仍还以85后妈妈为主，但95后妈妈所占据的比例已在成倍速提升，慢慢将逐渐代替85后妈妈，成为母婴消费市场的主力军。针对95后妈妈常用的母婴类平台调研发现，95后妈妈对于像宝宝树、亲宝宝、妈妈网孕育、妈妈帮、柚宝宝等母婴综合类平台的渗透率和活跃指数都较高，综合电商类平台和母婴垂直类平台稍微次之。</p><p>这表明95后妈妈与80、85后妈妈一样，习惯在宝宝树、京东、小红书等综合性平台上获取育儿知识，并进行消费。</p>','2020-06-29 09:55:47'),
(5,'5.jpg','什么是叶黄素 叶黄素的作用及原理','<p>叶黄素自然界中与玉米黄素共同存在，是构成玉米、蔬菜、水果、花卉等植物色素的主要组分，含于叶子的叶绿体中，可将吸收的光能传递给叶绿素a，推测对光氧化、光破坏具有保护作用。也是构成人眼视网膜黄斑区域的主要色素。叶黄素是人类日常食用生果及蔬菜时可吸收到的营养素，但吸收利用率一般较低。如果缺乏叶黄素，可服用补充剂。如果有较差消化系统的老年人，可以使用舌下的喷剂来补充叶黄素。早在1996年叶黄素已被加入为膳食补充剂。另外，过量吸取叶黄素会对肝脏造成多余的负担，建议用量每日大约为12毫克。</p><p>叶黄素主要存在于蔬菜中，虽然它属于类胡萝卜素，但是胡萝卜并不是叶黄素最好的食物来源，颜色越是深绿色的蔬菜，通常叶黄素的含量越高。如芥蓝、绿色花椰菜、菠菜、芦笋、绿色莴苣等，都含有丰富的叶黄素。蛋黄也是不错的叶黄素提供者。视网膜的主要色素成分：叶黄素与玉米黄素构成了蔬菜、水果、花卉等植物色素的主要组分，也是人眼视网膜黄斑区域*的主要色素。人类的眼睛含有高量的叶黄素，这种元素是人体无法制造的，必须靠摄入叶黄素来补充，若缺乏这种元素，眼睛就会失明。保护视力：叶黄素作为抗氧化剂和光保护作用，可促进视网膜细胞中视紫质（Rhodopsin）的再生成，可预防重度近视及视网膜剥离，并可增进视力、保护视力。</p>','2020-06-29 09:55:49'),
(6,'6.jpg','儿童营养补充问题多，不如试试这个方法？','<p>宝贝的健康成长是每个父母的心愿，所以，在儿童生长发育时期，很多宝爸宝妈们就不断地给孩子补充各种营养素。经常会听到宝妈们说：我家娃枕秃了，赶紧买了钙片补一补；我家娃最近不爱吃饭，电视广告说缺锌，得补锌；我家补.......，市面广告的宣传加上现在父母的焦虑，对孩子就买了各样各样的营养素进行补充。美其名曰：绝对不能让孩子缺少营养，输在起跑线上！当孩子摄入合理的营养素时，身体机能保持良好的状态,可降低疾病发生的几率;而不合理的营养素摄入，会影响孩子的身体活动，甚至导致亚健康状态与疾病的发生。</p><p>所以，合理的摄入营养素才是保证健康的关键因素。但是营养素的合理摄入量并不是统一的,而是因人而异的,它和个体的遗传因素有密切的关系，这个遗传因素就是我们要说的基因。每个孩子都是独一无二的，拥有不一样的基因。基因型不同，对营养素的吸收、代谢都不同，携带不同基因型的个体对某些营养素的需求也是不同的。科学的基因检测，可以评估个体对多种营养素的代谢能力、吸收能力及偏好，可以为孩子们的营养膳食做出个性化指导，从而让身体获取均衡的营养成分、避免不合理的膳食摄入对身体造成伤害。</p>','2020-06-29 09:55:51'),
(7,'7.jpg','如何判断宝宝可能缺乏哪些维生素？','<p>维生素是一种是维持人体健康所必需的一类有机化合物，它不供给能量，需要量又极少，但却是维持人体正常生理功能的重要物质。</p><p>维生素缺乏会影响生长发育；过量则会引起中毒。</p><p>一般情况下维生素来源于食物，比如维生素A、B、C 、叶酸等；只有维生素D和烟酸可在体内合成。可合成又受一些条件制约，以至于合成量不足仍需适当补充。维生素缺乏原因</p><p>1、食物供应严重不足，摄入不足；如：食物单一、储存不当、烹饪破坏等。比如叶酸受热损失。</p><p>2、吸收利用降低；如：消化系统疾病或摄入脂肪量过少从而影响脂溶性Vit的吸收。</p><p>3、维生素需要量相对增高；如：妊娠和哺乳期妇女、儿童、特殊工种、特殊环境下的人群。</p><p>4、不合理使用抗生素会导致对维生素的需要量增加。</p>','2020-06-29 09:55:53'),(8,'8.jpg','科学阐明孩子夏季补锌有多重要','<p>烈日炎炎，很多宝妈宝爸诉苦着天天带孩子去医院有多痛苦。</p><p>然而宝宝生病的原因却惊人类似。夏季是一年中最容易缺锌的季节， 每年7 、8 月份看病的宝宝， 缺锌的发生率高达6 0％ 以上。所以在盛夏来临之际，应做好补锌的准备。摄取不足锌主要来源于瘦肉、肝、蛋、奶等动物蛋白食品，夏天宝宝不喜欢吃荤腥，导致锌摄入减少。另外，夏天宝宝容易患上消化道疾病，也会影响锌的吸收。</p><p>出汗过多夏天气温高，容易出汗，汗中含有较多的锌，导致锌丢失过多，宝宝一天随汗液丢失的锌可高达4毫克。宝宝和树木一样，春夏季节生长发育较快，特别是新生儿和婴幼儿，他们本身生长发育就迅速，需要锌量大，所以容易出现锌缺乏。</p><p>其他原因人工喂养的宝宝更容易缺锌。因为初乳中含锌量比成熟乳高，宝宝出生后未哺初乳或母乳不足，又没有及时添加富锌辅食，就会导致锌摄入不足。另外，早产、偏食挑食、患佝偻病以及易出汗的宝宝都容易缺锌。柠檬酸锌为有机锌补剂，对胃刺激小，含锌量高，并且在人体内参与三羧酸循环，增强人体消化吸收功能，柠檬酸锌是存在人体母乳中的唯一的一种锌配合物,比牛奶中的锌更易于吸收,而且性能稳定。所以给宝宝补好锌，宝宝也能健康开心。</p>','2020-06-29 09:55:55');
